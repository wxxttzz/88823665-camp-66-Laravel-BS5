{{-- เทมเพลตเลย์เอาท์ข้อผิดพลาด --}}
{{-- เทมเพลตนี้ใช้เป็นเลย์เอาท์พื้นฐานสำหรับหน้าข้อผิดพลาด --}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{url('assets/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">                </div>
                <div class="info">
